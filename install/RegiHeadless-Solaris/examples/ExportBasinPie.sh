...
../jre64/bin/java -cp ../lib/*:../lib/ext/*:../lib/regi/*:../lib/cwms/*:../lib/sys/*: -Djava.library.path=../lib64 -DPLUGINS=../lib/ext -Doracle.metrics.clientid="CWMS REGI-Headless-v3.3" -Dcwms.db.impl.classpaths=../runtimeclassloader/cwmsDbApi/jooq -Doracle.url=$ORA_INST -Doracle.officeId=$OFFICE_ID -Dhec.passwd=$PASS_FILE -Djava.util.logging.config.file=../config/properties/logging.properties usace.rowcps.headless.RegiCLI -Drowcps.timezone=America/Chicago -p ..//examples//credentials.properties -f ..//examples//BasinPie.py
