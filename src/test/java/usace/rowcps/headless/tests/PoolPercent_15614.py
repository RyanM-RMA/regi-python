...
officeID = "SWT"
percentCalc.calculatePoolPercents(officeID, "EUFA",  startCal.getTime(), endCal.getTime())
#percentCalc.calculatePoolPercents(officeID, "SKIA",  startCal.getTime(), endCal.getTime())
